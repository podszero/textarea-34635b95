...
const StatusBar = ({ content, isPreview, isSaved }: StatusBarProps) => {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-4 left-4 xs:bottom-5 xs:left-5 sm:bottom-6 sm:left-6 md:bottom-8 md:left-8 z-40 flex items-center gap-2.5 xs:gap-3 sm:gap-4 text-[11px] xs:text-xs sm:text-sm text-muted-foreground font-sans safe-bottom bg-background/90 backdrop-blur-md px-3 py-2 xs:px-3.5 xs:py-2 sm:px-4 sm:py-2.5 rounded-full border border-border/40 shadow-sm"
    >
